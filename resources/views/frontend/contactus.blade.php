  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
        ...
        <form id="contact-form" method="post" action="contact-usc.php" role="form">
          <div class="controls">
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <input id="form_name" type="text" name="form_name" class="form-control" placeholder="First Name"
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <input id="form_email" type="email" name="form_email" class="form-control" placeholder="Email"
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <input id="form_phone" type="tel" name="form_phone" class="form-control" placeholder="Phone no.">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <input id="form_subject" type="text" name="form_subject" class="form-control" placeholder="Subject"
            ...
            <div class="row mt-2">
              <div class="col-lg-12">
                <div class="form-group">
                  <textarea id="form_message" name="form_message" class="form-control" placeholder="Message..." rows="4"
      ...
      <div class="col-lg-5 address-box">
        ...
        <ul class="footer-social">
          <li><a href="https://www.facebook.com/fitnet.in/" target="_blank"><i class="fa fa-facebook-f"></i></a></li>
          ...
          <li><a href="https://www.instagram.com/fitnetgroup/" target="_blank"><i class="fa fa-instagram"></i></a></li>

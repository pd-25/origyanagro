            ...
            <div class="row mb-5">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input id="lname" type="text" name="lname" class="form-control" required="required"
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  <label>Phone</label>
                  <input id="Phone" type="text" name="Phone" class="form-control" required="required"
            ...
            <div class="row mb-5">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input id="Street_address" type="text" name="Street_address" class="form-control" required="required"
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input id="Apartment" type="text" name="Apartment" class="form-control" required="required"
                    data-error="Apartment is required.">
                </div>
              </div>
            </div>

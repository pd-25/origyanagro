                    ...
                    <div id="owl-category" class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="category-box">
                                ...
                                <h4><a href="" class="rm-btn-sm">Organic Oil & Ghee</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
                                <img src="{{ asset('frontend-asset/images/cat-pic2.png') }}" class="img-fluid">
                                <h4><a href="" class="rm-btn-sm">Sugar, Salt & Jaggery</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
                                <img src="{{ asset('frontend-asset/images/cat-pic3.png') }}" class="img-fluid">
                                <h4><a href="" class="rm-btn-sm">Rice & Rice Products</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
                                <img src="{{ asset('frontend-asset/images/cat-pic4.png') }}" class="img-fluid">
                                <h4><a href="" class="rm-btn-sm">Dry Fruits & Nuts</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
                                <img src="{{ asset('frontend-asset/images/cat-pic5.png') }}" class="img-fluid">
                                <h4><a href="" class="rm-btn-sm">Organic Tea & Coffee</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
                                <img src="{{ asset('frontend-asset/images/cat-pic6.png') }}" class="img-fluid">
                                <h4><a href="" class="rm-btn-sm">Organic Pulses & Dal</a></h4>
                            </div>
                        </div>
                        <div class="item">
                            <div class="category-box">
            ...
            <div class="col-lg-12">
                <div class="portfolio-menu mt-2 mb-4">
                    <ul>
                        ...
                        <li class="btn btn-outline-dark" data-filter=".category1">Rice & Rice Products</li>
